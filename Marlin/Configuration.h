...
#define STRING_CONFIG_H_AUTHOR "(inib, GeraltR, AIIoT)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sapphire Pro BL"
...
/*///A$CF SapphirePro 50W MonsterHeater (bore heatbreak, no sock no fans @200° C)
  #define DEFAULT_Kp 9.31
  #define DEFAULT_Ki 0.41
  #define DEFAULT_Kd 52.82
  /*///A$C SapphirePro 104GT-2
...
#define EXTRUDE_MAXLENGTH 650 //A$ maybe needed for filament loading
...
#define USE_YMAX_PLUG //A$ Sapphire Pro uses Y-MAX, if you want 0,0 to be front left
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.3, 1600, 410.2 } //A$CF
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 30, 45 } //A$A keep speed reasonable
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 200, 2000 } //A$ keep speed reasonable
 ...
 */
//#define PROBE_MANUALLY  //UNDO A$BL
...
#define INVERT_X_DIR true //A$ TMC2208 behavior
...
#define INVERT_E0_DIR true //A$C TMC2209 behavior
...
#define X_BED_SIZE 220 //A$CF
#define Y_BED_SIZE 220 //A$CF
...
//#define MESH_BED_LEVELING  //UNDO A$BL
